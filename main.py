...
# Predefined PDF path
PDF_PATH = "C:\\Users\\Ali Musharaf\\Downloads\\nayatelinformation.pdf"  # Update this path to your PDF file path
...
def main():
    ...
    # User question input
    user_question = st.text_input("Ask a question regarding Nayatel services:")
